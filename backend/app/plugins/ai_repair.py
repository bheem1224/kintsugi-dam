...
from backend.app.plugins.base import RemediationProvider

logger = logging.getLogger(__name__)


class CloudAIRepair(RemediationProvider):
    def get_name(self) -> str:
        """Returns the name of the provider."""
        return "CloudAIRepair"
    ...
    async def find_clean_version(
        ...
        """
        return "kintsugi://ai-repair-pending"
    ...
    async def restore_file(self, backup_uri: str, live_destination: str) -> bool:
        ...
        logger.warning("AI Repair is hard-locked for Beta")
        return False
